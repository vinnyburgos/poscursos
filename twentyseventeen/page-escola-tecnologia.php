...
<?php
/*
Template Name: Escola de Tecnologia
Template Post Type: page
*/

/**
 * Template para a página "Escola de Tecnologia" (escola-de-saude).
 *
 * Este arquivo exibe a página da Escola de Tecnologia.
 */

get_header(); 
?>
<!-- TOPO ESTILO ESCOLA DE TECNOLOGIA (igual print 2) -->
<section class="escola-header-bg">
	<div class="escola-header-content">
		<div class="escola-breadcrumb">Home &gt; Pós-Graduação &gt; Escola de Tecnologia</div>
		<div class="escola-header-title">ESCOLA DE TECNOLOGIA</div>

		<div class="escola-header-sub">Lidere a transformação digital com domínio em dados, IA e tecnologia da informação.</div><br><br><br>
	</div>
</section>
...
.escola-header-bg {
	...
	background: url("https://poscursos.unisuam.edu.br/wp-content/uploads/2026/04/tecnologia.png") no-repeat center center / cover;
	padding: 0;
	min-height: 220px;
	position: relative;
	display: block;
...
<section class="pos-para-voce" style="background: #fff; padding: 40px 0;">
	<div class="center" style="display: flex; align-items: center; justify-content: center; gap: 48px; flex-wrap: wrap;">
		<div class="pos-para-voce-ilustracao" style="flex: 0 0 320px; max-width: 340px; min-width: 220px; text-align: center;">
			...
			<img src="https://poscursos.unisuam.edu.br/wp-content/uploads/2026/04/img-tecnologia.png" alt="Profissional de saúde" style="max-width: 100%; height: auto;" />
		</div>
		<div class="pos-para-voce-texto" style="flex: 1 1 400px; min-width: 280px;">
			...
			<p style="font-size: 1.08rem; color: #23272F; margin-bottom: 18px; line-height: 1.6;">
				Nossas especializações são focadas em quem deseja dominar a <b>estratégia tecnológica</b> e a <b>inteligência operacional</b> das organizações. <br><br>
			...
			<ul class="lista-fa" style="font-size: 1.08rem; color: #23272F; margin-left: 0; padding-left: 0; line-height: 1.7; list-style: none;">
				<li><i class="fa-solid fa-diamonds-4 lista-fa-icon" aria-hidden="true"></i><span><b>Querem dominar a era dos dados</b> e buscam maestria em <b>Ciência de Dados e Inteligência Artificial</b> para prever cenários e automatizar o sucesso;</span></li>
				<li><i class="fa-solid fa-diamonds-4 lista-fa-icon" aria-hidden="true"></i><span><b>Lideram a Transformação Digital</b> e precisam de visão estratégica para remodelar modelos de negócio e influenciar decisões de alto nível;</span></li>
				<li><i class="fa-solid fa-diamonds-4 lista-fa-icon" aria-hidden="true"></i><span><b>Orquestram cadeias complexas</b> e buscam excelência em <b>Logística e Supply Chain Management</b> para otimizar fluxos e escalar resultados globais;</span></li>
				<li><i class="fa-solid fa-diamonds-4 lista-fa-icon" aria-hidden="true"></i><span><b>Sabem que o mercado não aceita obsolescência</b> e entendem que a união entre <b>análise de dados, processos ágeis e liderança estratégica</b> é o único caminho para blindar a carreira.</span></li>
			</ul>
		</div>
	</div>
</section>
		...
		<div class="wrapContent">
			...
			<div class="boxEnsino BoxEnsino2">
				...
				<!-- <ul> -->
					...
					<b>Autonomia para a sua evolução</b><br><br>
		A solução para quem tem rotina intensa e precisa de flexibilidade total para estudar onde quiser, sem abrir mão da qualidade técnica.
		...
		<div class="lorem-grid" style="display: flex; flex-wrap: wrap; gap: 24px 32px; justify-content: center; margin-bottom: 36px;">
			...
			<div class="cardNew">
				...
				<span>
					...
					Ensino reconhecido e de alto nível. O peso necessário para o seu currículo ser destaque em processos de <b>liderança técnica e consultoria estratégica</b>.</span>
				</span>
			</div>
			<!-- Card 2 -->
			<div class="cardNew">
				...
				<span>
					...
					<span style="font-size: 1rem; color: #23272F;">Aprenda com <b>CTOs, especialistas em IA e gestores de tecnologia</b> que vivem os desafios reais da transformação digital nas grandes corporações.</span>
				</span>
			</div>
			<!-- Card 3 -->
			<div class="cardNew">
			<span style="display: flex; align-items: baseline; justify-content: center; min-width: 48px;">
				...
				<span>
					<strong style="font-size: 1.13rem; color: #23272F; display: block; margin-bottom: 4px;">Infraestrutura à sua disposição: </strong>
					<span style="font-size: 1rem; color: #23272F;">Mesmo nas modalidades <b>Digital (EAD)</b> ou <b>Digital Ao Vivo</b>, você tem <b>acesso livre às bibliotecas e laboratórios</b> em nossas três unidades.</span>
				</span>
			</div>
			<!-- Card 4 -->
			<div class="cardNew">
				...
				<span>
					...
					<span style="font-size: 1rem; color: #23272F;">Da governança ágil à inteligência artificial preditiva, desenvolva a visão analítica e a confiança para implementar <b>soluções tecnológicas</b>.</span>
				</span>
			</div>
		</div>
	</div>
...
<!-- AREA DO SLIDE DOS CURSOS  -->
		...
		document.addEventListener('DOMContentLoaded', function () {
			...
			if (tituloConheca) {
				tituloConheca.textContent = 'CONHEÇA OS CURSOS DA ESCOLA DE TECNOLOGIA';
			}
		});
		</script>
<!-- AREA DO SLIDE DOS CURSOS  -->
...
<script>
				 ...
				 */
				document.addEventListener('DOMContentLoaded', function() {
					var AREA_DESEJADA = 'Tecnologia'; // <<< ALTERE AQUI O NOME DA ÁREA DESEJADA
					var normalizar = function(valor) {
						return (valor || '')
							.toString()
							.normalize('NFD').replace(/[\u0300-\u036f]/g, '')
