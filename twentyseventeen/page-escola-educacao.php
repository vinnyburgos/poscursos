...
<?php
/*
Template Name: Escola de Educação
Template Post Type: page
*/

/**
 * Template para a página "Escola de Educação" (escola-de-saude).
 *
 * Este arquivo exibe a página da Escola de Educação.
 */

get_header(); 
?>
<!-- TOPO ESTILO ESCOLA DE EDUCAÇÃO (igual print 2) -->
<section class="escola-header-bg">
	<div class="escola-header-content">
		<div class="escola-breadcrumb">Home &gt; Pós-Graduação &gt; Escola de Educação</div>
		<div class="escola-header-title">ESCOLA DE EDUCAÇÃO</div>

		<div class="escola-header-sub">Especialize-se para fazer a diferença em cada etapa da educação: da sala de aula à gestão escolar.</div><br><br><br>
	</div>
</section>
...
.escola-header-bg {
	background: linear-gradient(90deg, #EF7D00 0%, #FFA726 100%);
	background: url("https://poscursos.unisuam.edu.br/wp-content/uploads/2026/04/educacao.png") no-repeat center center / cover;
	padding: 0;
	min-height: 220px;
	position: relative;
	display: block;
...
<script>
		document.addEventListener('DOMContentLoaded', function () {
			...
			if (tituloConheca) {
				tituloConheca.textContent = 'CONHEÇA OS CURSOS DA ESCOLA DE EDUCAÇÃO';
			}
		});
</script>
...
<section class="pos-para-voce" style="background: #fff; padding: 40px 0;">
	<div class="center" style="display: flex; align-items: center; justify-content: center; gap: 48px; flex-wrap: wrap;">
		<div class="pos-para-voce-ilustracao" style="flex: 0 0 320px; max-width: 340px; min-width: 220px; text-align: center;">
			...
			<img src="https://poscursos.unisuam.edu.br/wp-content/uploads/2026/04/img-educacao.png" alt="Profissional de saúde" style="max-width: 100%; height: auto;" />
		</div>
		<div class="pos-para-voce-texto" style="flex: 1 1 400px; min-width: 280px;">
			...
			<p style="font-size: 1.08rem; color: #23272F; margin-bottom: 18px; line-height: 1.6;">
				As especializações da UNISUAM são feitas para quem acredita no poder transformador da educação e sabe que ensinar é evoluir constantemente.<br><br>
			...
			<ul class="lista-fa" style="font-size: 1.08rem; color: #23272F; margin-left: 0; padding-left: 0; line-height: 1.7; list-style: none;">
				<li><i class="fa-solid fa-diamonds-4 lista-fa-icon" aria-hidden="true"></i><span>Estão em sala de aula ou em ambientes educacionais e querem aprimorar suas práticas pedagógicas com mais estratégia e inovação;</span></li>
				<li><i class="fa-solid fa-diamonds-4 lista-fa-icon" aria-hidden="true"></i><span>Atuam em escolas, cursos, projetos sociais ou gestão educacional e buscam uma formação prática e aplicável ao dia a dia;</span></li>
				<li><i class="fa-solid fa-diamonds-4 lista-fa-icon" aria-hidden="true"></i><span>Querem assumir cargos de coordenação, direção ou liderança educacional com mais segurança e visão estratégica;</span></li>
				<li><i class="fa-solid fa-diamonds-4 lista-fa-icon" aria-hidden="true"></i><span>Desejam se aprofundar em áreas como educação inclusiva, psicopedagogia, gestão escolar, metodologias ativas ou tecnologias educacionais;</span></li>
				<li><i class="fa-solid fa-diamonds-4 lista-fa-icon" aria-hidden="true"></i><span>Sabem que, na educação, atualizar-se é essencial para engajar, ensinar melhor e transformar realidades.</span></li>
			</ul>
		</div>
	</div>
</section>
		...
		<div class="wrapContent">
			<div class="boxEnsino boxEnsino1">
				...
				<!-- <ul> -->
					...
					Vivencie o aprendizado em <b>laboratórios de última geração</b> e aulas práticas.<br><br>É a escolha ideal para quem busca <b>networking de alto nível</b> com professores que são referência no mercado e troca direta de experiências em tempo real.
			...
			<div class="boxEnsino boxEnsino3">
				...
				<!-- <ul> -->
					...
					A solução definitiva para quem precisa conciliar estudos com a rotina intensa de trabalho.<br><br>Estude com <b>conteúdo de excelência</b> onde e quando quiser, garantindo uma especialização de peso com a flexibilidade que a sua agenda exige.
			...
			<div class="boxEnsino BoxEnsino2">
				...
				<!-- <ul> -->
					...
					<b>O equilíbrio entre autonomia e tecnologia no processo de aprendizagem.</b><br><br>
					
					O equilíbrio perfeito entre tecnologia e conexão.<br><br>Participe de <b>aulas em tempo real</b>, interaja com grandes nomes da educação e tire dúvidas na hora, unindo a flexibilidade do digital à força do aprendizado colaborativo.
			...
			<p class="contentBoxEnsino" style="color:rgba(87, 96, 111, 1) ;margin: 20px auto;max-width:700px;line-height: 23px;">Estude no seu próprio ritmo, com acesso a conteúdos de qualidade, atividades interativas e suporte pedagógico, desenvolvendo disciplina e independência nos estudos.</p>
		</div>
</section>
		...
		<div class="lorem-grid" style="display: flex; flex-wrap: wrap; gap: 24px 32px; justify-content: center; margin-bottom: 36px;">
			...
			<div class="cardNew">
				...
				<span>
					...
					Conclua sua Pós-Graduação <b>a partir de 6 meses</b> na modalidade Digital (EAD) ou em <b>1 ano</b> nos modelos Presencial e Digital ao Vivo. Formação ágil sem abrir mão da qualidade acadêmica.</span>
				</span>
			</div>
			<!-- Card 2 -->
			<div class="cardNew">
			...
			<div class="cardNew">
				...
				<span>
					...
					<span style="font-size: 1rem; color: #23272F;">Suas aulas são ministradas por <b>professores renomados e atuantes </b>no mercado. Você não estuda apenas a teoria: você estuda o que o mercado está praticando agora.</span>
				</span>
			</div>
			<!-- Card 4 -->
			<div class="cardNew">
				<span style="display: flex; align-items: baseline; justify-content: center; min-width: 48px;">
					<img style="width:90%;" src="https://poscursos.unisuam.edu.br/wp-content/uploads/2026/icons/icon-nota-maxima.svg" alt="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				</span>
				<span>
					<strong style="font-size: 1.13rem; color: #23272F; display: block; margin-bottom: 4px;">Do jeito que cabe na sua rotina:</strong>	
					<span style="font-size: 1rem; color: #23272F;">Liberdade para escolher como aprender. Seja na unidade, em casa com aulas gravadas ou na interatividade do ao vivo, entregamos a mesma qualidade de ensino para que nada interrompa sua evolução profissional.</span>
				</span>
			</div>
		</div>
	</div>
...
<section class="historias">
	...
	<div style="text-align: center; margin-top: 36px;">
		<p style="font-size: 1.35rem; color: #23272F; margin-bottom: 0; max-width:900px;margin: 0 auto;">
			<b>A ciência aplicada à educação</b>. Veja como <b>Gedson Glabson</b>, aluno da Pós-Graduação em <b>Neurociência e Aprendizagem</b>, uniu evidências científicas e prática pedagógica na UNISUAM para se tornar um especialista de destaque e transformar sua atuação no ensino.
		</p><br><br>
	</div>
	<div style="text-align:center;">

		<iframe width="560" height="315" src="https://www.youtube.com/embed/OHNXQF5wCfI?si=epPcTTvkqCo4Jyau" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
<script>
				 ...
				 */
				document.addEventListener('DOMContentLoaded', function() {
					var AREA_DESEJADA = 'Educação'; // <<< ALTERE AQUI O NOME DA ÁREA DESEJADA
					var normalizar = function(valor) {
						return (valor || '')
							.toString()
							.normalize('NFD').replace(/[\u0300-\u036f]/g, '')
