...
<?php
/*
Template Name: Escola de Gastronomia
Template Post Type: page
*/

/**
 * Template para a página "Escola de Gastronomia" (escola-de-gastronomia).
 *
 * Este arquivo exibe a página da Escola de Gastronomia.
 */

get_header(); 
?>
<!-- TOPO ESTILO ESCOLA DE GASTRONOMIA (igual print 2) -->
<section class="escola-header-bg">
	<div class="escola-header-content">
		<div class="escola-breadcrumb">Home &gt; Pós-Graduação &gt; Escola de Gastronomia</div>
		<div class="escola-header-title">ESCOLA DE GASTRONOMIA</div>

		<div class="escola-header-sub">Eleve sua técnica e construa uma carreira sólida do fogão à gestão gastronômica.</div><br><br><br>
	</div>
</section>
...
.escola-header-bg {
	background: linear-gradient(90deg, #004070 0%, #009FC6 100%);
	background: url("https://poscursos.unisuam.edu.br/wp-content/uploads/2026/04/gastronomia.png") no-repeat center center / cover;
	padding: 0;
	min-height: 220px;
	position: relative;
	display: block;
...
<?php if (!defined('UNISUAM_FA6_INCLUDED')): ?>
	<?php define('UNISUAM_FA6_INCLUDED', true); ?>
...
<script>
		document.addEventListener('DOMContentLoaded', function () {
			...
			if (tituloConheca) {
				tituloConheca.textContent = 'CONHEÇA OS CURSOS DA ESCOLA GASTRONOMIA';
			}
		});
</script>
...
<section class="pos-para-voce" style="background: #fff; padding: 40px 0;">
	<div class="center" style="display: flex; align-items: center; justify-content: center; gap: 48px; flex-wrap: wrap;">
		<div class="pos-para-voce-ilustracao" style="flex: 0 0 320px; max-width: 340px; min-width: 220px; text-align: center;">
			...
			<img src="https://poscursos.unisuam.edu.br/wp-content/uploads/2026/04/img-gastronomia.png" alt="Profissional de saúde" style="max-width: 100%; height: auto;" />
		</div>
		<div class="pos-para-voce-texto" style="flex: 1 1 400px; min-width: 280px;">
			...
			<p style="font-size: 1.08rem; color: #23272F; margin-bottom: 18px; line-height: 1.6;">
				As especializações da UNISUAM são feitas para quem vive a rotina da cozinha de perto e sabe que técnica, repertório e gestão transformam paixão em negócio. 
				<br><br>
			...
			<ul class="lista-fa" style="font-size: 1.08rem; color: #23272F; margin-left: 0; padding-left: 0; line-height: 1.7; list-style: none;">
				<li><i class="fa-solid fa-diamonds-4 lista-fa-icon" aria-hidden="true"></i><span>Desejam dominar técnicas clássicas e contemporâneas para criar com identidade e autoria;</span></li>
				<li><i class="fa-solid fa-diamonds-4 lista-fa-icon" aria-hidden="true"></i><span>Atuam em restaurantes, hotéis, buffets ou eventos e buscam especialização prática e aplicável;</span></li>
				<li><i class="fa-solid fa-diamonds-4 lista-fa-icon" aria-hidden="true"></i><span>Querem assumir cargos de chefia, liderança ou gestão operacional e financeira no setor;</span></li>
				<li><i class="fa-solid fa-diamonds-4 lista-fa-icon" aria-hidden="true"></i><span>Desejam aprofundar-se em áreas como Gastronomia Brasileira, Contemporânea, Patisserie ou Boulangerie;</span></li>
				<li><i class="fa-solid fa-diamonds-4 lista-fa-icon" aria-hidden="true"></i><span>Sabem que, na gastronomia, a atualização constante e o domínio técnico são a base do sucesso.</span></li>
			</ul>
		</div>
	</div>
</section>
		...
		<div class="wrapContent">
			<div class="boxEnsino boxEnsino1">
				...
				<!-- <ul> -->
					...
					<!-- <b>A imersão que a cozinha exige</b><br><br> -->
					Estude em Bonsucesso ou Bangu e vivencie o aprendizado em cozinhas pedagógicas completas. É a escolha ideal para quem busca networking de alto nível com chefs que são referência no mercado e a troca direta de experiências no calor do fogão.
	...
	<div class="center" style="max-width: 1100px; margin: 0 auto;">
		...
		<div class="lorem-grid" style="display: flex; flex-wrap: wrap; gap: 24px 32px; justify-content: center; margin-bottom: 36px;">
			...
			<div class="cardNew">
				...
				<span>
					<strong style="font-size: 1.13rem; color: #23272F; display: block; margin-bottom: 4px;">Nota máxima no MEC:</strong>
					<span style="font-size: 1rem; color: #23272F;">
					Ensino reconhecido e certificado a excelência que o seu currículo precisa.</span>
				</span>
			</div>
			<!-- Card 2 -->
			<div class="cardNew">
				...
				<span>
					...
					<span style="font-size: 1rem; color: #23272F;">Tenha acesso a laboratórios modernos e desenvolva suas habilidades em um ambiente controlado e seguro, utilizando equipamentos de última geração para garantir o máximo de precisão e confiança.</span>
				</span>
			</div>
			<!-- Card 3 -->
			<div class="cardNew">
				...
				<span>
					...
					<span style="font-size: 1rem; color: #23272F;">Aprenda com Chefs e Gestores que possuem ampla experiência e atuação real no mercado gastronômico nacional e internacional.</span>
				</span>
			</div>
			<!-- Card 4 -->
			<div class="cardNew">
				...
				<span>
					<strong style="font-size: 1.13rem; color: #23272F; display: block; margin-bottom: 4px;">Prática Profissional:</strong>	
					<span style="font-size: 1rem; color: #23272F;">ulas 100% presenciais focadas na "mão na massa", com estrutura real, cozinhas modernas e acompanhamento próximo.</span>
				</span>
			</div>
		</div>
	</div>
...
<section class="historias">
	...
	<div style="text-align: center; margin-top: 36px;">
		<p style="font-size: 1.35rem; color: #23272F; margin-bottom: 0; max-width:900px;margin: 0 auto;">
			<b>Onde a experiência encontra a especialização.</b> Assista ao depoimento de <b>Raquel Mirelli</b>, Chef do renomado <b>Restaurante Alcaparra</b> e aluna da Pós-Graduação UNISUAM. Descubra como a técnica e a prática real nas aulas foram decisivas para o seu sucesso profissional.
		</p><br><br>
	</div>
	<div style="text-align:center;">

		<iframe width="560" height="315" src="https://www.youtube.com/embed/6VRZPvkUtC0?si=ccLBqyqCH-ZDjOxI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
<script>
				 ...
				 */
				document.addEventListener('DOMContentLoaded', function() {
					var AREA_DESEJADA = 'Gastronomia'; // <<< ALTERE AQUI O NOME DA ÁREA DESEJADA
					var normalizar = function(valor) {
						return (valor || '')
							.toString()
							.normalize('NFD').replace(/[\u0300-\u036f]/g, '')
