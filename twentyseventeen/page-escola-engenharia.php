...
<?php
/*
Template Name: Escola de Engenharia
Template Post Type: page
*/

/**
 * Template para a página "Escola de Engenharia" (escola-de-saude).
 *
 * Este arquivo exibe a página da Escola de Engenharia.
 */

get_header(); 
?>
<!-- TOPO ESTILO ESCOLA DE ENGENHARIA (igual print 2) -->
<section class="escola-header-bg">
	<div class="escola-header-content">
		<div class="escola-breadcrumb">Home &gt; Pós-Graduação &gt; Escola de Engenharia e Arquitetura</div>
		<div class="escola-header-title">ESCOLA DE ENGENHARIA E ARQUITETURA</div>

		<div class="escola-header-sub">Aprofunde seu conhecimento técnico e faça a diferença em cada fase do projeto: da concepção à execução.</div><br><br><br>
	</div>
</section>
...
.escola-header-bg {
	background: linear-gradient(90deg, #004070 0%, #0076A8 100%);
	background: url("https://poscursos.unisuam.edu.br/wp-content/uploads/2026/04/engenharia.png") no-repeat center center / cover;
	padding: 0;
	min-height: 220px;
	position: relative;
	display: block;
...
<script>
		document.addEventListener('DOMContentLoaded', function () {
			...
			if (tituloConheca) {
				tituloConheca.textContent = 'CONHEÇA OS CURSOS DA ESCOLA DE ENGENHARIA E ARQUITETURA';
			}
		});
</script>
...
<section class="pos-para-voce" style="background: #fff; padding: 40px 0;">
	<div class="center" style="display: flex; align-items: center; justify-content: center; gap: 48px; flex-wrap: wrap;">
		<div class="pos-para-voce-ilustracao" style="flex: 0 0 320px; max-width: 340px; min-width: 220px; text-align: center;">
			...
			<img src="https://poscursos.unisuam.edu.br/wp-content/uploads/2026/04/img-engenharia.png" alt="Profissional de saúde" style="max-width: 100%; height: auto;" />
		</div>
		<div class="pos-para-voce-texto" style="flex: 1 1 400px; min-width: 280px;">
			...
			<p style="font-size: 1.08rem; color: #23272F; margin-bottom: 18px; line-height: 1.6;">
				As especializações da UNISUAM são feitas para profissionais que querem ir além da execução e assumir protagonismo em projetos, obras e soluções de engenharia e arquitetura.<br><br>

				<b>Nossos cursos foram pensados para quem:</b>

			</p>
			<ul class="lista-fa" style="font-size: 1.08rem; color: #23272F; margin-left: 0; padding-left: 0; line-height: 1.7; list-style: none;">
				<li><i class="fa-solid fa-diamonds-4 lista-fa-icon" aria-hidden="true"></i><span>Atua em obras, indústrias ou escritórios técnicos e quer ganhar mais domínio sobre processos, normas e tomada de decisão;</span></li>
				<li><i class="fa-solid fa-diamonds-4 lista-fa-icon" aria-hidden="true"></i><span>Busca evoluir tecnicamente em áreas como estruturas, automação, segurança do trabalho, design de interiores ou gestão de projetos;</span></li>
				<li><i class="fa-solid fa-diamonds-4 lista-fa-icon" aria-hidden="true"></i><span>Quer assumir cargos de liderança em obras, coordenação de equipes ou gestão de projetos de engenharia;</span></li>
				<li><i class="fa-solid fa-diamonds-4 lista-fa-icon" aria-hidden="true"></i><span>Deseja se especializar em áreas estratégicas como BIM, perícia técnica, engenharia diagnóstica ou controle e automação;</span></li>
				<li><i class="fa-solid fa-diamonds-4 lista-fa-icon" aria-hidden="true"></i><span>Sabe que, na engenharia e na arquitetura, atualização constante é o que garante competitividade, segurança e crescimento profissional.</span></li>
			</ul>
		</div>
	</div>
</section>
		...
		<div class="wrapContent">
			<div class="boxEnsino boxEnsino1">
				...
				<!-- <ul> -->
					...
					Aprenda na prática com estudos de caso, projetos aplicados e interação direta com professores experientes. Ideal para quem busca aprofundamento técnico e troca de experiências com outros profissionais da área.
			...
			<div class="boxEnsino boxEnsino3">
				...
				<!-- <ul> -->
					...
					Participe de aulas em tempo real, discuta casos reais da engenharia e interaja com especialistas do mercado. Mais dinamismo e conexão para potencializar seu aprendizado.
			...
			<div class="boxEnsino BoxEnsino2">
				...
				<!-- <ul> -->
					...
					A escolha certa para quem precisa conciliar rotina intensa de obras, projetos e prazos. Estude no seu ritmo, com conteúdos atualizados e foco total na aplicação profissional.
	...
	<div class="center" style="max-width: 1100px; margin: 0 auto;">
		...
		<div class="lorem-grid" style="display: flex; flex-wrap: wrap; gap: 24px 32px; justify-content: center; margin-bottom: 36px;">
			...
			<div class="cardNew">
				...
				<span>
					<strong style="font-size: 1.13rem; color: #23272F; display: block; margin-bottom: 4px;">Conteúdo alinhado ao mercado: </strong>
					<span style="font-size: 1rem; color: #23272F;">Tenha acesso a conhecimentos atualizados com as principais demandas da engenharia, incluindo normas técnicas, novas tecnologias e metodologias como BIM.</span>
				</span>
			</div>
			<!-- Card 3 -->
			<div class="cardNew">
				...
				<span>
					...
					<span style="font-size: 1rem; color: #23272F;">Aprenda com profissionais que atuam diretamente em obras, projetos e consultorias. Aqui, você estuda com quem vive os desafios reais da engenharia todos os dias.</span>
				</span>
			</div>
			<!-- Card 4 -->
			<div class="cardNew">
				<span style="display: flex; align-items: baseline; justify-content: center; min-width: 48px;">
					<img style="width:90%;" src="https://poscursos.unisuam.edu.br/wp-content/uploads/2026/icons/icon-liberdade.svg" alt="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				</span>
				<span>
					<strong style="font-size: 1.13rem; color: #23272F; display: block; margin-bottom: 4px;">Do jeito que cabe na sua rotina:</strong>	
					<span style="font-size: 1rem; color: #23272F;">Flexibilidade para evoluir no seu tempo. Escolha entre o presencial, o digital ou o ao vivo e tenha a mesma qualidade de ensino para crescer na engenharia e conquistar novas oportunidades.</span>
				</span>
			</div>
		</div>
	</div>
...
<section class="historias">
	...
	<div style="text-align: center; margin-top: 36px;">
		<p style="font-size: 1.35rem; color: #23272F; margin-bottom: 0; max-width:900px;margin: 0 auto;">
			Onde a perícia técnica encontra a especialização. Veja como <b>Soraya Cristina</b>, aluna da Pós em Engenharia Legal e Diagnóstica, utilizou a metodologia prática da UNISUAM para dominar a elaboração de laudos periciais e auditorias, consolidando sua autoridade no mercado de engenharia diagnóstica e avaliações.
		</p><br><br>
	</div>
	<div style="text-align:center;">

		<iframe width="560" height="315" src="https://www.youtube.com/embed/KTlfCD5b3iw" frameborder="0" allowfullscreen></iframe>
...
<script>
				 ...
				 */
				document.addEventListener('DOMContentLoaded', function() {
					var AREA_DESEJADA = 'engenharia e arquitetura'; // <<< ALTERE AQUI O NOME DA ÁREA DESEJADA
					var normalizar = function(valor) {
						return (valor || '')
							.toString()
							.normalize('NFD').replace(/[\u0300-\u036f]/g, '')
