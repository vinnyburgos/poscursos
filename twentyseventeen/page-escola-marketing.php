...
<?php
/*
Template Name: Escola de Marketing
...
<section class="escola-header-bg">
	<div class="escola-header-content">
		<div class="escola-breadcrumb">Home &gt; Pós-Graduação &gt; Escola de Comunicação e Marketing</div>
		<div class="escola-header-title">ESCOLA DE COMUNICAÇÃO E MARKETING</div>

		<div class="escola-header-sub">Desenvolva conexões reais e resultados concretos: do marketing de experiência ao crescimento digital com IA.</div><br><br><br>
	</div>
</section>
...
.escola-header-bg {
	...
	background: url("https://poscursos.unisuam.edu.br/wp-content/uploads/2026/04/comunicacao-mkt.png") no-repeat center center / cover;
	padding: 0;
	min-height: 220px;
	position: relative;
	display: block;
...
<script>
		document.addEventListener('DOMContentLoaded', function () {
			...
			if (tituloConheca) {
				tituloConheca.textContent = 'CONHEÇA OS CURSOS DA ESCOLA DE COMUNICAÇÃO E MARKETING';
			}
		});
</script>
	...
	<div class="center" style="display: flex; align-items: center; justify-content: center; gap: 48px; flex-wrap: wrap;">
		...
		<div class="pos-para-voce-texto" style="flex: 1 1 400px; min-width: 280px;">
			...
			<p style="font-size: 1.08rem; color: #23272F; margin-bottom: 18px; line-height: 1.6;">
				As especializações da UNISUAM são feitas para quem quer se destacar em um mercado dinâmico, criativo e em constante transformação.<br><br>
			...
			<ul class="lista-fa" style="font-size: 1.08rem; color: #23272F; margin-left: 0; padding-left: 0; line-height: 1.7; list-style: none;">
				<li><i class="fa-solid fa-diamonds-4 lista-fa-icon" aria-hidden="true"></i><span>Atuam ou desejam atuar nas áreas de comunicação, marketing, mídias digitais ou produção de conteúdo;</span></li>
				<li><i class="fa-solid fa-diamonds-4 lista-fa-icon" aria-hidden="true"></i><span>Querem desenvolver estratégias mais eficientes, criativas e orientadas a resultados;</span></li>
				<li><i class="fa-solid fa-diamonds-4 lista-fa-icon" aria-hidden="true"></i><span>Buscam se atualizar com as novas tendências do mercado, como marketing digital, redes sociais, Growth e Inteligência Artificial;</span></li>
				<li><i class="fa-solid fa-diamonds-4 lista-fa-icon" aria-hidden="true"></i><span>Desejam assumir posições estratégicas, liderar projetos ou gerenciar marcas e campanhas;</span></li>
				<li><i class="fa-solid fa-diamonds-4 lista-fa-icon" aria-hidden="true"></i><span>Sabem que, na comunicação, acompanhar as mudanças do mercado é essencial para se manter relevante.</span></li>
			</ul>
		</div>
	</div>
</section>
		...
		<div class="lorem-grid" style="display: flex; flex-wrap: wrap; gap: 24px 32px; justify-content: center; margin-bottom: 36px;">
			...
			<div class="cardNew">
				...
				<span>
					...
					Conclua sua Pós-Graduação a partir de 6 meses na modalidade Digital (EAD) ou em 1 ano nos formatos Presencial e Digital ao Vivo. Evolua com agilidade sem abrir mão da qualidade.</span>
				</span>
			</div>
			<!-- Card 2 -->
			<div class="cardNew">
...
<script>
				 ...
				 */
				document.addEventListener('DOMContentLoaded', function() {
					var AREA_DESEJADA = 'marketing'; // <<< ALTERE AQUI O NOME DA ÁREA DESEJADA (pode ser parte do nome)
					var normalizar = function(valor) {
						return (valor || '')
							.toString()
							.normalize('NFD').replace(/[\u0300-\u036f]/g, '')
