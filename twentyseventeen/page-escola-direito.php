...
<?php
/*
Template Name: Escola de Direito
Template Post Type: page
*/

/**
 * Template para a página "Escola de Direito" (escola-de-direito).
 *
 * Este arquivo exibe a página da Escola de Direito.
 */

get_header(); 
?>
<!-- TOPO ESTILO ESCOLA DE DIREITO (igual print 2) -->
<section class="escola-header-bg">
	<div class="escola-header-content">
		<div class="escola-breadcrumb">Home &gt; Pós-Graduação &gt; Escola de Direito</div>
		<div class="escola-header-title">ESCOLA DE DIREITO</div>

		<div class="escola-header-sub">Desenvolva expertise jurídica e atue com autoridade: do compliance à defesa dos direitos trabalhistas.</div><br><br><br>
	</div>
</section>
...
.escola-header-bg {
	background: linear-gradient(90deg, #F05200 0%, #FFA726 100%);
	background: url("https://poscursos.unisuam.edu.br/wp-content/uploads/2026/04/direito.png") no-repeat center center / cover;
	padding: 0;
	min-height: 220px;
	position: relative;
	display: block;
...
<script>
		document.addEventListener('DOMContentLoaded', function () {
			...
			if (tituloConheca) {
				tituloConheca.textContent = 'CONHEÇA OS CURSOS DA ESCOLA DE DIREITO';
			}
		});
</script>
...
<section class="pos-para-voce" style="background: #fff; padding: 40px 0;">
	<div class="center" style="display: flex; align-items: center; justify-content: center; gap: 48px; flex-wrap: wrap;">
		<div class="pos-para-voce-ilustracao" style="flex: 0 0 320px; max-width: 340px; min-width: 220px; text-align: center;">
			...
			<img src="https://poscursos.unisuam.edu.br/wp-content/uploads/2026/04/img-direito.png" alt="Profissional de saúde" style="max-width: 100%; height: auto;" />
		</div>
		<div class="pos-para-voce-texto" style="flex: 1 1 400px; min-width: 280px;">
			...
			<p style="font-size: 1.08rem; color: #23272F; margin-bottom: 18px; line-height: 1.6;">
				As especializações da UNISUAM foram desenhadas para advogados e bacharéis que buscam profundidade técnica e atualização constante em um cenário jurídico que não para de mudar. <br><br>
			...
			<ul class="lista-fa" style="font-size: 1.08rem; color: #23272F; margin-left: 0; padding-left: 0; line-height: 1.7; list-style: none;">
				<li><i class="fa-solid fa-diamonds-4 lista-fa-icon" aria-hidden="true"></i><span>Buscam o domínio técnico das constantes atualizações e reformas do Direito do Trabalho e Previdenciário;</span></li>
				<li><i class="fa-solid fa-diamonds-4 lista-fa-icon" aria-hidden="true"></i><span>Precisam conciliar a rotina intensa de tribunais e prazos com uma formação de alto nível;</span></li>
				<li><i class="fa-solid fa-diamonds-4 lista-fa-icon" aria-hidden="true"></i><span>Desejam construir uma autoridade técnica indiscutível para atuar em causas de alta complexidade;</span></li>
				<li><i class="fa-solid fa-diamonds-4 lista-fa-icon" aria-hidden="true"></i><span>Querem se destacar em concursos públicos ou na advocacia privada com um currículo de peso;</span></li>
				<li><i class="fa-solid fa-diamonds-4 lista-fa-icon" aria-hidden="true"></i><span>Sabem que, no Direito, a diferença entre o sucesso e a estagnação está na especialização contínua.</span></li>
			</ul>
		</div>
	</div>
</section>
		...
		<div class="wrapContent">
			<div class="boxEnsino boxEnsino1">
				...
				<p class="contentBoxEnsino">
					...
					Aulas práticas com metodologias ativas em salas equipadas para simulações jurídicas. Com laboratórios modernos, bibliotecas completas e uma infraestrutura acolhedora para transformar teoria em resultados para a sua carreira.
			...
			<div class="boxEnsino BoxEnsino2">
				...
				<p class="contentBoxEnsino">
					...
					<!-- <b>A autonomia que a sua carreira jurídica exige. </b><br><br> -->

					Sua rotina de prazos e audiências não precisa parar. Com o nosso modelo Digital, você tem flexibilidade total para estudar onde e quando quiser, acessando conteúdos atualizados e suporte especializado para evoluir no seu ritmo, sem abrir mão da qualidade técnica.
		...
		<div class="lorem-grid" style="display: flex; flex-wrap: wrap; gap: 24px 32px; justify-content: center; margin-bottom: 36px;">
			...
			<div class="cardNew">
				...
				<span>
					...
					Ensino com o selo máximo de qualidade o reconhecimento necessário para o seu currículo ter peso em tribunais, escritórios e  concursos.</span>
				</span>
			</div>
			<!-- Card 2 -->
			<div class="cardNew">
				...
				<span>
					<strong style="font-size: 1.13rem; color: #23272F; display: block; margin-bottom: 4px;">Corpo Docente Especialista: </strong>
					<span style="font-size: 1rem; color: #23272F;">Aprenda com mestres, doutores e profissionais que vivem a prática jurídica e trazem a realidade dos tribunais para o ambiente virtual.</span>
				</span>
			</div>
			<!-- Card 3 -->
			<div class="cardNew">
				...
				<span>
					<strong style="font-size: 1.13rem; color: #23272F; display: block; margin-bottom: 4px;">Prática Profissional (Cases Jurídicos):  </strong>
					<span style="font-size: 1rem; color: #23272F;">Saia do teórico. Estude casos reais e jurisprudências atualizadas, focando na aplicação prática do Direito para a solução de conflitos.</span>
				</span>
			</div>
			<!-- Card 4 -->
			<div class="cardNew">
				...
				<span>
					<strong style="font-size: 1.13rem; color: #23272F; display: block; margin-bottom: 4px;">Atualização e Repertório: </strong>	
					<span style="font-size: 1rem; color: #23272F;">Fique à frente das novas leis e tendências do judiciário, desenvolvendo a segurança necessária para construir teses vencedoras e atuar com protagonismo.</span>
				</span>
			</div>
		</div>
	</div>
...
<section class="historias">
	...
	<div style="text-align:center;">
		...
		<iframe width="560" height="315" src="https://www.youtube.com/embed/XMaKJJHQrxk?si=HiTDW71Z1KGvlJfU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
<script>
				 ...
				 */
				document.addEventListener('DOMContentLoaded', function() {
					var AREA_DESEJADA = 'Sociais e Direito'; // <<< ALTERE AQUI O NOME DA ÁREA DESEJADA (pode ser parte do nome)
					var normalizar = function(valor) {
						return (valor || '')
							.toString()
							.normalize('NFD').replace(/[\u0300-\u036f]/g, '')
					...
					cards.forEach(function(card) {
						...
						var encontrado = nomes.some(function(nome) {
							return nome.indexOf(areaDesejadaNorm) !== -1;
						});
						if (encontrado) {
							card.style.display = '';
						} else {
...
AREA DE INTERESSE
https://poscursos.unisuam.edu.br/?area=Sociais+e+Direito
