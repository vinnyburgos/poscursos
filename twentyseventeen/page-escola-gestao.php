...
<?php
/*
Template Name: Escola de Gestão
Template Post Type: page
*/

/**
 * Template para a página "Escola de Gestão" (escola-de-saude).
 *
 * Este arquivo exibe a página da Escola de Gestão.
 */

get_header(); 
?>
<!-- TOPO ESTILO ESCOLA DE GESTÃO (igual print 2) -->
<section class="escola-header-bg">
	<div class="escola-header-content">
		<div class="escola-breadcrumb">Home &gt; Pós-Graduação &gt; Escola de Gestão</div>
		<div class="escola-header-title">ESCOLA DE GESTÃO</div>

		<div class="escola-header-sub">Prepare-se para assumir posições de liderança com conhecimento sólido e visão de mercado.</div><br><br><br>
	</div>
</section>
...
.escola-header-bg {
	background: linear-gradient(90deg, #7D378D 0%, #8E44AD 100%);
	background: url("https://poscursos.unisuam.edu.br/wp-content/uploads/2026/04/MBA-em-Gestao-de-Negocios.png") no-repeat center center / cover;
	padding: 0;
	min-height: 220px;
	position: relative;
	display: block;
...
<script>
		document.addEventListener('DOMContentLoaded', function () {
			...
			if (tituloConheca) {
				tituloConheca.textContent = 'CONHEÇA OS CURSOS DA ESCOLA DE GESTÃO';
			}
		});
</script>
...
<section class="pos-para-voce" style="background: #fff; padding: 40px 0;">
	<div class="center" style="display: flex; align-items: center; justify-content: center; gap: 48px; flex-wrap: wrap;">
		<div class="pos-para-voce-ilustracao" style="flex: 0 0 320px; max-width: 340px; min-width: 220px; text-align: center;">
			...
			<img src="https://poscursos.unisuam.edu.br/wp-content/uploads/2026/04/img-gestao.webp" alt="Profissional de saúde" style="max-width: 100%; height: auto;" />
		</div>
		<div class="pos-para-voce-texto" style="flex: 1 1 400px; min-width: 280px;">
			...
			<p style="font-size: 1.08rem; color: #23272F; margin-bottom: 18px; line-height: 1.6;">
				As especializações da UNISUAM são focadas em quem deseja liderar o mercado. <br><br>
			...
			<ul class="lista-fa" style="font-size: 1.08rem; color: #23272F; margin-left: 0; padding-left: 0; line-height: 1.7; list-style: none;">
				<li><i class="fa-solid fa-diamonds-4 lista-fa-icon" aria-hidden="true"></i><span><b>Dominam a operação e agora miram o C-Level:</b> Buscam o topo da pirâmide em cargos de Gestão Empresarial, Controladoria e Auditoria;</span></li>
				<li><i class="fa-solid fa-diamonds-4 lista-fa-icon" aria-hidden="true"></i><span><b>Gerenciam o maior ativo das empresas: as pessoas:</b> Buscam excelência em Liderança, Recrutamento Estratégico e Gestão de RH para construir times de alta performance;</span></li>
				<li><i class="fa-solid fa-diamonds-4 lista-fa-icon" aria-hidden="true"></i><span><b>Desejam unir Métodos Ágeis e Resultados:</b> Querem dominar a Gestão de Projetos e Processos para eliminar gargalos e acelerar a entrega de valor;</span></li>
				<li><i class="fa-solid fa-diamonds-4 lista-fa-icon" aria-hidden="true"></i><span><b>Focam na saúde financeira e segurança do negócio:</b> Buscam maestria em Planejamento Tributário, Compliance e Gestão de Riscos para blindar a organização;</span></li>
				<li><i class="fa-solid fa-diamonds-4 lista-fa-icon" aria-hidden="true"></i><span><b>Lideram a linha de frente do mercado:</b> Buscam estratégias de Marketing Digital, Vendas e Inteligência Artificial para escalar resultados e dominar a experiência do cliente.</span></li>
			</ul>
		</div>
	</div>
</section>
		...
		<div class="wrapContent">
			<div class="boxEnsino boxEnsino1">
				...
				<!-- <ul> -->
					...
					<b>Networking e imersão estratégica</b><br><br>
			Troque experiências diretamente com quem decide no mercado. Aulas práticas no campus focadas em conexões reais e resolução conjunta de problemas.
			...
			<!-- <div class="boxEnsino boxEnsino3">
				...
				<p class="contentBoxEnsino">
					...
					A dinâmica da sala de aula direto na sua tela. Interaja com professores e colegas, tire dúvidas na hora e discuta casos atuais ao vivo.
			...
			<div class="boxEnsino BoxEnsino2">
				...
				<!-- <ul> -->
					...
					<b>Interatividade em tempo real</b><br><br>
		A interatividade que você precisa para trocar experiências, tirar dúvidas críticas e expandir seu networking executivo com a flexibilidade do digital.
...
<section class="bloco-lorem-institucional" style="background: #fff; padding: 48px 0 32px 0;">
	<div class="center" style="max-width: 1100px; margin: 0 auto;">
		<div style="text-align: center;">
			...
			<h2 style="font-size: 2.3rem; font-weight: 800; margin-bottom: 18px; color: #23272F; letter-spacing: 0.01em; text-transform: uppercase;">DIFERENCIAIS QUE CONSOLIDAM SUA LIDERANÇA</h2>
		...
		<div class="lorem-grid" style="display: flex; flex-wrap: wrap; gap: 24px 32px; justify-content: center; margin-bottom: 36px;">
			...
			<div class="cardNew">
				...
				<span>
					...
					Ensino reconhecido e de alto nível, o peso necessário para o seu currículo ser destaque em processos de diretoria e consultoria.</span>
				</span>
			</div>
			<!-- Card 2 -->
			<div class="cardNew">
				...
				<span>
					...
					<span style="font-size: 1rem; color: #23272F;">Aprenda com gestores, auditores e especialistas em tecnologia que vivem os desafios reais das grandes corporações.</span>
				</span>
			</div>
			<!-- Card 3 -->
			<div class="cardNew">
				<span style="display: flex; align-items: baseline; justify-content: center; min-width: 48px;">
					<img style="width:90%;" src="https://poscursos.unisuam.edu.br/wp-content/uploads/2026/icons/icon-foco-resultado.svg" alt="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				</span>
				<span>
					<strong style="font-size: 1.13rem; color: #23272F; display: block; margin-bottom: 4px;">Prática profissional (Foco em Resultados): </strong>
					<span style="font-size: 1rem; color: #23272F;">Aulas baseadas em estudos de caso e ferramentas de mercado. Utilize laboratórios modernos para auditoria e implementação de IA.</span>
				</span>
			</div>
			<!-- Card 4 -->
			<div class="cardNew">
				<span style="display: flex; align-items: baseline; justify-content: center; min-width: 48px;">
					<img style="width:90%;" src="https://poscursos.unisuam.edu.br/wp-content/uploads/2026/icons/icon-tendencias.svg" alt="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				</span>
				<span>
					<strong style="font-size: 1.13rem; color: #23272F; display: block; margin-bottom: 4px;">Tendências e repertório: </strong>	
					<span style="font-size: 1rem; color: #23272F;">Da governança clássica à inteligência artificial, desenvolva a visão analítica e a confiança para implementar soluções que geram valor imediato.</span>
				</span>
			</div>
		</div>
	</div>
...
<section class="historias">
	...
	<div style="text-align: center; margin-top: 36px;">
		<p style="font-size: 1.35rem; color: #23272F; margin-bottom: 0; max-width:900px;margin: 0 auto;">
			Assista ao depoimento de <b>Gabriela Ramaciote</b> e descubra por que profissionais que buscam o topo escolhem a UNISUAM. Entenda como nossa metodologia transforma teoria em ferramentas práticas para você dominar o mercado de trabalho.
		</p><br><br>
	</div>
	<div style="text-align:center;">

		<iframe width="560" height="315" src="https://www.youtube.com/embed/XMaKJJHQrxk?si=VI7GzK35TBkfLLrC" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
<script>
				 ...
				 */
				document.addEventListener('DOMContentLoaded', function() {
					var AREA_DESEJADA = 'Gestão'; // <<< ALTERE AQUI O NOME DA ÁREA DESEJADA
					var normalizar = function(valor) {
						return (valor || '')
							.toString()
							.normalize('NFD').replace(/[\u0300-\u036f]/g, '')
